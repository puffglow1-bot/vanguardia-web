        ...
        <div className="container mx-auto max-w-4xl bg-brand-bg p-12 border border-brand-border">
          ...
          <div className="space-y-12 text-brand-accent font-light leading-relaxed text-sm md:text-base">
            <section>
              ...
              <p>
                Bienvenido a New Talent Management. Al acceder y utilizar nuestro sitio web, usted acepta cumplir con los siguientes términos y condiciones de uso. Si no está de acuerdo con alguna parte de estos términos, le rogamos que no utilice nuestro sitio.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Aunque nos esforzamos por mantener la información del sitio actualizada y precisa (incluyendo noticias sobre fichajes y estadísticas), New Talent Management no garantiza la exactitud, integridad o actualidad de la información. La Agencia no será responsable de ningún daño directo, indirecto, incidental o consecuente que resulte del uso o la imposibilidad de uso de este sitio.
              </p>
            </section>
